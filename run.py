...
from kea_method import end_to_end_kea
...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--method', type=str, required=True, choices=['rake', 'gensim', 'kea', 'word2vec'],
    ...
    if args.method == 'kea':
        end_to_end_kea(args.use_postprocessing)
    else:
